...
try:
    ...
    sql = 'select value from vpc_disk_util_stat_max where '
    ...
    sql = 'select value from vpc_disk_util_stat_mean where '
    sql += ' time > ' + beginTS + ' and time <= ' + endTS
    sql += ' group by account_id,group_name,instance_name;'
    # print sql
    ...
    sql = 'select value from vpc_disk_util_stat_min where '
    sql += ' time > ' + beginTS + ' and time <= ' + endTS
    sql += ' group by account_id,group_name,instance_name;'
    # print sql
